...
- **2. Forecasting Model Training** – Implements training utilities (`train_sir_model_mse`, `train_sir_model_dfl`) and tracks cost/mse histories.
...
- **4. GDF Training and Reporting** – Provides multi-panel plotting helpers (`plot_three_columns_three_cities`, `plot_four_rows_three_cities_with_cost`, etc.) to compare GDP, prediction-only, online, and ground-truth strategies across cities.
